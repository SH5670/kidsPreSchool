...
?>
    ...
    <head>
        ...
        <title>Kids PreSchool Enrollment System | Rejected Enrollments</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="text-danger">Rejected Enrollments</h1>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $enrol_rs = Database::search("SELECT * FROM `enrollments` INNER JOIN `classType` ON enrollments.classType_id=classType.id WHERE enrollStatus_id='2'");
