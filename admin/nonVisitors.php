...
?>
    ...
    <head>
        ...
        <title>Kids PreSchool Enrollment System | Non Visited Visitors</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="text-danger">Non Visited Visitors</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="adminDashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active">Non Visited Visitors</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $visitors_rs = Database::search("SELECT * FROM `visitors` WHERE visitors.status_id='3'");
